...
class ModelHandler(object):
    ...
    def initialize(self, context):
        ...
        self._batch_size = properties.get("batch_size", 1)
    ...
    def inference(self, model_input):
        print("inference is about to call")
        """
    ...
    def handle(self, data, context):
        ...
        """
        print("inference handler called -----------------------------------")
        model_input = self.preprocess(data)
        model_out = self.inference(model_input)
        inference_out = self.postprocess(model_out)[0]
        print("output json" , inference_out)
...
def handle(data, context):
    ...
    if data is None:
        return None
    print('handle is about to call................', data)
